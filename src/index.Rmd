...
abstract: "Peruskurssi Qfield-lisäosan ja mobiilisovelluksen käytöstä."
output:
    bookdown::html_book:
        toc: true
        theme: null
...
-   **QField on suomenkielinen**. QField-käyttöliittymä on suomennettu. Myös ruotsinkielinen versio on käytettävissä ilman lisäkustannuksia. Käyttöohjeita, web-sivustoja ja muita materiaaleja kehitetään ja suomennetaan jatkuvasti.
...
::: note-box
<https://qfield.org/docs/index.html>\
:::
